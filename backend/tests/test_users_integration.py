...
class TestUsersApiIntegration:
    ...
    def test_list_users_returns_current_tenant_only(self, client, tenant_tenant_tenant_manager_token, db_session, tenant):
    ...
    def test_get_user_profile_returns_current_user(self, client, tenant_tenant_tenant_manager_token, admin_user):
    ...
    def test_get_user_by_id_returns_full_details(self, client, tenant_tenant_tenant_manager_token, user_in_tenant, tenant):
    ...
    def test_get_user_cross_tenant_forbidden(self, client, tenant_tenant_tenant_manager_token, other_tenant, db_session):
    ...
    def test_create_user_successful(self, client, tenant_tenant_tenant_manager_token, tenant):
    ...
    def test_create_duplicate_user_fails(self, client, tenant_tenant_tenant_manager_token, user_in_tenant):
    ...
    def test_update_user_fields(self, client, tenant_tenant_tenant_manager_token, user_in_tenant):
    ...
    def test_delete_user_removes_from_database(self, client, tenant_tenant_tenant_manager_token, user_in_tenant, db_session):
...
class TestBulkUploadIntegration:
    ...
    def test_bulk_upload_csv_file(self, client, tenant_tenant_tenant_manager_token, tenant_with_department):
...
jane@example.com,Jane Smith,Engineering,dept_lead"""
    ...
    def test_bulk_upload_xlsx_file(self, client, tenant_tenant_tenant_manager_token, tenant_with_department):
        ...
        ws.append(['john@example.com', 'John Doe', 'Engineering', 'tenant_user'])
    ...
    def test_bulk_upload_retrieves_staging_data(self, client, tenant_tenant_tenant_manager_token, db_session, tenant_with_department):
...
john@example.com,John Doe,Engineering,tenant_user"""
    ...
    def test_bulk_upload_confirm_creates_users(self, client, tenant_tenant_tenant_manager_token, db_session, tenant_with_department):
...
john@example.com,John Doe,Engineering,tenant_user"""
    ...
    def test_bulk_upload_error_rows_dont_create_users(self, client, tenant_tenant_tenant_manager_token, db_session, tenant_with_department):
...
invalid-email,John Doe,NonexistentDept,invalid_role"""
    ...
    def test_bulk_upload_permission_check(self, client, tenant_user_token):
...
class TestUsersValidation:
    ...
    def test_invalid_email_rejected(self, client, tenant_tenant_tenant_manager_token):
    ...
    def test_invalid_role_rejected(self, client, tenant_tenant_tenant_manager_token):
