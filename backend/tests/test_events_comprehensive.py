...
class TestEventsApiIntegration:
    ...
    def test_list_events_by_tenant(self, client, tenant_admin_token, db_session, tenant):
    ...
    def test_create_event_success(self, client, tenant_admin_token, tenant):
    ...
    def test_get_event_by_id(self, client, tenant_admin_token, db_session, tenant):
    ...
    def test_update_event(self, client, tenant_admin_token, db_session, tenant):
    ...
    def test_delete_event(self, client, tenant_admin_token, db_session, tenant):
    ...
    def test_event_cross_tenant_forbidden(self, client, tenant_admin_token, other_tenant, db_session):
    ...
    def test_list_events_with_filters(self, client, tenant_admin_token, db_session, tenant):
    ...
    def test_event_pagination(self, client, tenant_admin_token):
...
class TestEventsValidation:
    ...
    def test_invalid_event_type_rejected(self, client, tenant_admin_token):
    ...
    def test_invalid_date_format_rejected(self, client, tenant_admin_token):
...
class TestE2EEventWorkflow:
    ...
    def test_e2e_create_list_update_delete_event(self, client, tenant_admin_token, db_session, tenant):
