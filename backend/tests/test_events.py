...
def setup_database():
    ...
    # Create test tenant admin user with tenant_tenant_tenant_manager role
    admin_user = User(
        id=ADMIN_USER_ID,
        tenant_id=tenant.id,
    ...
    # Create test regular user with tenant_user role
    regular_user = User(
        id=REGULAR_USER_ID,
        tenant_id=tenant.id,
...
def get_token(user_id: str, email: str, org_role: str = "tenant_tenant_tenant_manager", tenant_id: str = TENANT_ID):
...
class TestEventCreation:
    ...
    def test_create_event_with_valid_token(self):
        ...
        token = get_token(ADMIN_USER_ID, "admin@test.com", "tenant_tenant_tenant_manager")
