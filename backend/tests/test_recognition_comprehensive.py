...
class TestRecognitionApiIntegration:
    ...
    def test_cannot_recognize_self(self, client, tenant_admin_token, tenant_with_users):
...
class TestBadgesIntegration:
    ...
    def test_list_available_badges(self, client, tenant_admin_token):
    ...
    def test_get_badge_by_id(self, client, db_session, tenant_admin_token, tenant):
