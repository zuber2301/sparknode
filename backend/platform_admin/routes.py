...
async def get_tenant(
    ...
    return TenantDetailResponse(
        ...
        billing_discount_pct=tenant.billing_discount_pct or Decimal('0'),
        billing_final_amount=tenant.billing_final_amount,
        billing_currency=tenant.billing_currency or tenant.display_currency or 'INR',
